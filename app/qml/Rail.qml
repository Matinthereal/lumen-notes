...
Rectangle {
    ...
    ColumnLayout {
        ...
        RailButton { Layout.alignment: Qt.AlignHCenter; icon: "document-properties"; tip: "This page: links to it (Ctrl+Shift+L)"; on: rail.rightPanel === "page"; onClicked: rail.rightPanel = rail.rightPanel === "page" ? "" : "page" }
